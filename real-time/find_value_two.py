        ...
        for record in matches:
            ...
            if home_name_tt and away_name_tt:
                ...
                if result_one:
                    ...
                    found = False
                    if (result_one["bet"] == 2 and result_one["p1_away_prob"] > 0.86):
                        found = True
                    elif (result_one["bet"] == 2 and result_one["p1_away_prob"] <= 0.86 and result_one["diff_last_tournaments"] > 4):
                        found = True
                    elif (result_one["bet"] == 2 and result_one["p1_away_prob"] <= 0.86 and result_one["experience"] < 0):
                        found = True
                    elif (result_one["bet"] == 2 and result_one["p1_away_prob"] <= 0.86 and result_one['diff_players_vs_opponents_50'] < -50):
                        found = True
                

                    if (result_one["bet"] == 1 and result_one["p0_home_prob"] > 0.8): # avg_opponents_home
                        found = True
                    elif (result_one["bet"] == 1 and result_one["p0_home_prob"] <= 0.8 and result_one["diff_last_tournaments"] < -4):
                        found = True
                    elif (result_one["bet"] == 1 and result_one["p0_home_prob"] <= 0.8 and result_one["experience"] > 0):
                        found = True
                    elif (result_one["bet"] == 1 and result_one["p0_home_prob"] <= 0.8 and result_one['diff_saved'] < -0.06):
                        found = True #diff_players_vs_opponents_50
                    elif (result_one["bet"] == 1 and result_one["p0_home_prob"] <= 0.8 and result_one['diff_players_vs_opponents_50'] > 50):
                        found = True                   
