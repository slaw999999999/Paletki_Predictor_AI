...
class AITraining(ValueEngine):
    def __init__(self):
        super().__init__()
        self.model_path = "trained_model_gradient_boosting.pkl"  # finalny pipeline (scaler + model)
    ...
    def evaluate_with_threshold_both(self, X, y, model_pipeline):
        ...
        # Predykcja prawdopodobieństw (model_pipeline zawiera scaler + model)
    ...
    def run_training(self):
        ...
        # 4. Definiujemy pipeline: scaler + GradientBoostingClassifier
        pipeline = Pipeline([
            ("scaler", MinMaxScaler()),
        ...
        # Wyświetlenie wybranych parametrów modelu
        # parametry modelu GB "gb" dostępne w pipeline.named_steps['gb']
        print("\nWybrane parametry Gradient Boosting:")
        print(pipeline.named_steps['gb'].get_params())
        ...
        # 9. Zapis finalnego pipeline do pliku
